 		var nb01 = document.getElementsByClassName('NB01');
        var nb02 = document.getElementsByClassName('NB02');
        var nb03 = document.getElementsByClassName('NB03');
        var nb04 = document.getElementsByClassName('NB04');
        var nb01_N = document.getElementsByClassName('NB01_N');
        var nb02_N = document.getElementsByClassName('NB02_N');
        var nb03_N = document.getElementsByClassName('NB03_N');
        var nb04_N = document.getElementsByClassName('NB04_N');
        var nb07 = document.getElementsByClassName('NB07');
        var nb08 = document.getElementsByClassName('NB08');
        var nb11 = document.getElementsByClassName('NB11');
        var nb12 = document.getElementsByClassName('NB12');
        var nb13 = document.getElementsByClassName('NB13');
        var nb14 = document.getElementsByClassName('NB14');
        var nb15 = document.getElementsByClassName('NB15');
        var nb16 = document.getElementsByClassName('NB16');
        var nb17 = document.getElementsByClassName('NB17');
        var nb18 = document.getElementsByClassName('NB18');
        var nb20 = document.getElementsByClassName('NB20');
        var nb21 = document.getElementsByClassName('NB21');
