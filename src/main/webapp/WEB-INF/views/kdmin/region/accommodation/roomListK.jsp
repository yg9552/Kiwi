  ...
  <!-- userHeader e -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">객실</h4>

              <!-- Hoverable Table rows -->
              <div class="card">
              	<h5 class="card-header">객실 검색</h5>
           		<div class="card-body">
           			<div class="row">
                ...
                <h5 class="card-header">객실 리스트</h5>
                    ...
                    <c:choose>
							...
							<c:otherwise>
	                        	<c:forEach items="${list}" var="list" varStatus="status">
		                          <tr>
		                            <td> <c:out value="${list.nxRoomSeq }"/> </td>
		                            <td>  </td>
		                            <td> <a href="javascript:goForm(<c:out value="${list.nxRoomSeq }"/>)"> <c:out value="${list.roomName }"/></a> </td>
		                            <td> 
		                            	<c:choose>
