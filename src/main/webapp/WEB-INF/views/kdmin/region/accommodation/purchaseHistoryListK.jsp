  ...
  <!-- userHeader e -->
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
              	<h5 class="card-header">예약내역 검색</h5>
           		<div class="card-body">
           			<div class="row">
                ...
                <h5 class="card-header">예약내역 리스트</h5>
							...
							<c:otherwise>
	                        	<c:forEach items="${list}" var="list" varStatus="status">
		                          <tr>
		                            ...
		                            <td> <c:out value="${list.paymentMethod }"/> </td>
		                            <td> <fmt:formatDate pattern="yyyy-MM-dd" value="${list.checkInDate}"/> </td>
		                            <td> <fmt:formatDate pattern="yyyy-MM-dd" value="${list.checkOutDate}"/> </td>
		                            <td> <fmt:formatNumber value="${list.pay }" pattern="#,###" /> </td>
		                            <td> <c:out value="${list.personnel }"/> </td>
	...
	var goUrlList = "/nextrip/purchaseHistoryListK";		/* #-> */
	
	var seq = $("input:hidden[name=nxPurchaseHistorySeq]");				/* #-> */
