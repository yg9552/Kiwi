...
<body>
	...
	<div class="container col-6" style="text-align: center; position:relative; top:120px;">
		<form method="post">
			...
			<div class="row mb-3">
				<span><a href=""><input type="button" class="btn" id="btnLogin" value="로그인" style="background-color:#014B85; color:white; width:320px;"></a></span>
			</div>
			<div class="container pb-5 row" style="font-size:14px; color:#737C88">
				<div class="col-2 offset-4">
					<p>비밀번호 재설정</p>
				</div>
				<div class="col-2">
					<a href="./memberRegistration.html"><p>회원가입</p></a>
				</div>
			</div>
